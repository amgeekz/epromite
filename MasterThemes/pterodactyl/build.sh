...
if [ ! -f "artisan" ]; then
    ...
    cp -r MasterThemes/pterodactyl/app ..
    cp -r MasterThemes/pterodactyl/config ..
    cp -r MasterThemes/pterodactyl/database ..
    cp -r MasterThemes/pterodactyl/public ..
    cp -r MasterThemes/pterodactyl/resources ..
    cp -r MasterThemes/pterodactyl/routes ..
