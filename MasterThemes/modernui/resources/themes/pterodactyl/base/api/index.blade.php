...
@section('content-header')
    <ol class="breadcrumb text-uppercase font-size-xs p-0">
        ...
        <li class="breadcrumb-item active" aria-current="page">@lang('navigation.account.api_access')</li>
    </ol>
    <h5 class="display-4 mt-1 mb-2 font-weight-bold">@lang('base.api.index.header')</h5>
    <p class="text-black-50 mb-0">@lang('base.api.index.header_sub')</p>
@endsection
            ...
            <div class="card card-box">
                <div class="card-header">
                    <div class="card-header--title">
                        <h5 class="my-3">Credentials List</h5>
                    </div>
