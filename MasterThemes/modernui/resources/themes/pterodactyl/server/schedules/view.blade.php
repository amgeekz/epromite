...
@section('content-header')
    <ol class="breadcrumb text-uppercase font-size-xs p-0">
        ...
        <li class="breadcrumb-item active" aria-current="page">@lang('server.schedule.manage.header')</li>
    </ol>
    <h5 class="display-4 mt-1 mb-2 font-weight-bold">@lang('server.schedule.manage.header')</h5>
    <p class="text-black-50 mb-0">{{ $schedule->name }}</p>
@endsection
            ...
            <div class="card card-box" id="containsTaskList">
                ...
                <div class="card-footer with-border" id="taskAppendBefore">
                    ...
                    <div class="pull-right">
                        {!! csrf_field() !!}
                        <button type="button" class="btn btn-sm btn-info" data-action="add-new-task"><i class="fa fa-plus"></i> @lang('server.schedule.task.add_more')</button>
