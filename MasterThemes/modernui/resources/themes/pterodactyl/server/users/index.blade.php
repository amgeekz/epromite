...
@section('content-header')
    <ol class="breadcrumb text-uppercase font-size-xs p-0">
        ...
        <li class="breadcrumb-item active" aria-current="page">@lang('navigation.server.subusers')</li>
    </ol>
    <h5 class="display-4 mt-1 mb-2 font-weight-bold">@lang('server.users.header')</h5>
    <p class="text-black-50 mb-0">@lang('server.users.header_sub')</p>
@endsection
        ...
        <div class="card card-box">
            <div class="card-header">
                <div class="card-header--title">
                    <h5 class="my-3">@lang('server.users.list')</h5>
                </div>
