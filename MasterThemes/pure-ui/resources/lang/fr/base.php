...
return [
    ...
    'account' => [
        ...
        'first_name' => 'Prénom',
        'last_name' => 'Nom',
        'update_identity' => 'Mettre à jour le profil',
    ...
    'security' => [
        ...
        '2fa_enabled' => 'L\'authentification à 2-Factor est activée sur ce compte et sera nécessaire pour se connecter au panel. Si vous souhaitez désactiver la 2FA, entrez simplement un jeton valide ci-dessous et soumettez le formulaire.',
        '2fa_disabled' => 'L\'authentification à 2-Factor est désactivée sur votre compte ! Vous pouvez activer 2FA afin d\'ajouter un niveau de protection supplémentaire sur votre compte.',
