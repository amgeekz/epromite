...
<div class="card-footer with-border task-list-item" data-target="task-clone">
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            <div data-attribute="remove-task-element">
                ...
                <div class="input-group-btn hidden">
                    <button type="button" class="btn btn-danger rounded-0" data-action="remove-task"><i class="fa fa-close"></i></button>
                </div>
            </div>
        </div>
    </div>
