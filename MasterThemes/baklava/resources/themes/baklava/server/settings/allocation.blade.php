                            ...
                            <tr>
                                ...
                                <td class="col-xs-2 middle">
                                    @if($allocation->id === $server->allocation_id)
                                        <a class="btn btn-xs btn-success btn-sm text-white disabled" data-action="set-default" data-allocation="{{ $allocation->hashid }}" role="button">@lang('strings.primary')</a>
                                    @else
                                        <a class="btn btn-xs btn-secondary btn-sm text-white" data-action="set-default" data-allocation="{{ $allocation->hashid }}" role="button">@lang('strings.make_primary')</a>
                                    @endif
                                </td>
                            </tr>
                        @endforeach
