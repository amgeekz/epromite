    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-footer with-border">
                ...
                <a href="/server/{{ $server->uuidShort }}/files#{{ rawurlencode($directory) }}" class="pull-right"><button class="btn btn-secondary btn-md">@lang('server.files.edit.return')</button></a>
            </div>
        </div>
    </div>
</div>
