...
<div class="row">
    <div class="col-md-12 mb-2">
        <a class="btn btn-md btn-info" href="{{ route('admin.packs.new') }}">Configure Manually</a>
        <a class="btn btn-md btn-primary" href="#modal" id="toggleModal">Install From Template</a>
    </div>
</div>
        ...
        <div class="col-md-6">
            <div class="card card-primary">
                ...
                <div class="card-footer with-border">
                    {!! csrf_field() !!}
                    <button class="btn btn-md btn-success pull-right" type="submit">Create Pack</button>
                </div>
            </div>
        </div>
    </div>
