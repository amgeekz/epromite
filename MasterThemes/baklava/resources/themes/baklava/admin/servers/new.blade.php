    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-footer no-border no-pad-top no-pad-bottom">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-header with-border" style="margin-top:-10px;">
                    <h3 class="card-title">Service Variables</h3>
                </div>
                <div class="card-body row" id="appendVariablesTo"></div>
