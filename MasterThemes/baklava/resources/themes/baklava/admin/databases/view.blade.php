        ...
        <div class="col-sm-6">
            <div class="card card-primary">
                ...
                <div class="card-footer">
                    {!! csrf_field() !!}
                    <button name="_method" value="PATCH" class="btn btn-md btn-primary pull-right">Save</button>
                    <button name="_method" value="DELETE" class="btn btn-md btn-danger pull-left muted muted-hover"><i class="feather icon-trash"></i></button>
                </div>
            </div>
        </div>
    </div>
