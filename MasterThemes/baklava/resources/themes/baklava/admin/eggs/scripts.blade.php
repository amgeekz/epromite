...
<div class="row">
    <div class="col-md-12 mb-2">
        ...
        <a class="btn btn-md btn-info" href="{{ route('admin.nests.egg.scripts', $egg->id) }}">Install Script</a>
    </div>
</div>
                ...
                @if(! is_null($egg->copyFrom))
                    <div class="card-body">
                        <div class="callout callout-warning no-margin">
                            This service option is copying installation scripts and container options from <a href="{{ route('admin.nests.egg.view', $egg->copyFrom->id) }}">{{ $egg->copyFrom->name }}</a>. Any changes you make to this script will not apply unless you select "None" from the dropdown card below.
                        </div>
                    </div>
                @endif
