...
<div class="row">
    <div class="col-md-12">
        <div class="card no-border">
            <div class="card-body">
                <a href="#" class="btn btn-md btn-success pull-right" data-toggle="modal" data-target="#newVariableModal">Create New Variable</a>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="card">
                ...
                <form action="{{ route('admin.nests.egg.variables.edit', ['id' => $egg->id, 'variable' => $variable->id]) }}" method="POST">
                    ...
                    <div class="card-footer">
                        {!! csrf_field() !!}
                        <button class="btn btn-md btn-primary pull-right" name="_method" value="PATCH" type="submit">Save</button>
                        <button class="btn btn-md btn-danger pull-left muted muted-hover mb-2" data-action="delete" name="_method" value="DELETE" type="submit"><i class="feather icon-trash"></i></button>
                    </div>
                </form>
            </div>
        </div>
