...
<div class="row">
    <div class="col-md-12 mb-2">
        ...
        <a class="btn btn-info btn-md" href="{{ route('admin.nodes.view.allocation', $node->id) }}">Allocation</a>
...
<div class="row">
    <div class="col-sm-8">
        <div class="card card-primary">
            ...
            <div class="card-body table-responsive no-padding" style="overflow-x: visible">
                        ...
                        <th>
                            <div class="btn-group hidden-xs">
                                ...
                                <ul class="dropdown-menu dropdown-massactions">
                                    <li><a href="#" id="selective-deletion" data-action="selective-deletion">@lang('server.allocations.delete') <i class="feather icon-trash"></i></a></li>
                                </ul>
                            </div>
                        </th>
                    </tr>
                    @foreach($node->allocations as $allocation)
                        <tr>
                            ...
                            <td class="col-sm-3 d-flex">
                                <input class="form-control input-sm" style="width: 100px;" type="text" value="{{ $allocation->ip_alias }}" data-action="set-alias" data-id="{{ $allocation->id }}" placeholder="none" />
                                <span class="input-loader m-auto" style="margin-left: 10px !important;"><i class="fa fa-refresh fa-spin fa-fw"></i></span>
                            </td>
                            ...
                            <td class="col-sm-1 text-center">
                                @if(is_null($allocation->server_id))
                                    <button data-action="deallocate" data-id="{{ $allocation->id }}" class="btn btn-sm btn-danger"><i class="feather icon-trash"></i></button>
                                @else
                                    <button class="btn btn-sm disabled"><i class="feather icon-trash"></i></button>
                                @endif
                            </td>
                        </tr>
                    @endforeach
