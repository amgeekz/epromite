            ...
            <div class="card">
                ...
                <form action="{{ route('account') }}" method="post">
                    ...
                    <div class="card-footer">
                        ...
                        <input type="submit" class="btn btn-primary btn-md" value="@lang('base.account.update_pass')" />
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="card">
                ...
                <form action="{{ route('account') }}" method="post">
                    ...
                    <div class="card-footer">
                        ...
                        <input type="submit" class="btn btn-primary btn-md" value="@lang('base.account.update_email')" />
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="card card-primary">
                <form action="{{ route('account') }}" method="POST">
                    ...
                    <div class="card-footer with-border">
                        ...
                        <button type="submit" class="btn btn-md btn-primary">@lang('base.account.update_identity')</button>
                    </div>
                </form>
            </div>
        </div>
