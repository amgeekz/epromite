    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-footer with-border">
                <div class="row">
                    <div class="col-sm-8">
                        <button class="btn btn-md btn-primary" id="create_file">@lang('server.files.add.create')</button>
                        <a href="{{ route('server.files.index', [ 'server' => $server->uuidShort, 'dir' => $directory ]) }}"><button class="btn btn-secondary btn-md">@lang('strings.cancel')</button></a>
                    </div>
                    <div class="col-sm-4">
