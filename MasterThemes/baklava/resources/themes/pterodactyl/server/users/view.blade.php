                ...
                @can('edit-subuser', $server)
                    <div class="card-body">
                        <div class="btn-group pull-left">
                            <a id="selectAllCheckcardes" class="btn btn-md btn-secondary text-white">@lang('strings.select_all')</a>
                            <a id="unselectAllCheckcardes" class="btn btn-md btn-secondary text-white">@lang('strings.select_none')</a>
                        </div>
                        {!! method_field('PATCH') !!}
                        <input type="submit" name="submit" value="@lang('server.users.update')" class="pull-right btn btn-md btn-primary" />
                    </div>
                @endcan
            </div>
        </div>
...
@section('footer-scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#selectAllCheckcardes').on('click', function () {
                $('input[type=checkbox]').prop('checked', true);
            });
            $('#unselectAllCheckcardes').on('click', function () {
