            ...
            <div class="card card-primary" id="containsTaskList">
                ...
                <div class="card-footer with-border" id="taskAppendBefore">
                    ...
                    <div class="pull-right">
                        ...
                        <button type="submit" class="btn btn-md btn-success" name="_method" value="PATCH">@lang('server.schedule.manage.submit')</button>
                    </div>
                    <div class="pull-left">
                        <button type="submit" class="btn btn-md btn-danger muted muted-hover" id="deleteButton" name="_method" value="DELETE"><i class="feather icon-trash"></i></button>
                    </div>
                </div>
            </div>
        </div>
