...
<div class="row">
    <div class="col-md-12">
        <div class="card {{ (Auth::user()->use_totp) ? 'card-success' : 'card-danger' }}">
            <div class="card-header with-border">
                <h3 class="card-title">@lang('base.security.2fa_header')</h3>
            </div>
            ...
            <form action="#" method="post" id="do_2fa">
                ...
                <div class="card-footer">
                    {!! csrf_field() !!}
                    <button type="submit" class="btn btn-success btn-md">@lang('base.security.enable_2fa')</button>
                </div>
            </form>
            @endif
        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('account.security.revoke', $session->id) }}">
                                                <button class="btn btn-sm btn-danger"><i class="feather icon-trash"></i> @lang('strings.revoke')</button>
                                            </a>
                                        </td>
                                    </tr>
                                @endforeach
