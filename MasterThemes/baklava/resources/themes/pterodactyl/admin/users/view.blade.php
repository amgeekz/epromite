...
<form action="{{ route('admin.users.view', $user->id) }}" method="post">
        ...
        <div class="col-md-6">
            <div class="card card-primary">
                ...
                <div class="card-footer">
                    {!! csrf_field() !!}
                    {!! method_field('PATCH') !!}
                    <input type="submit" value="Update User" class="btn btn-primary btn-md">
                </div>
            </div>
        </div>
        <div class="col-md-6">
    ...
    {{--<div class="col-xs-12">--}}
        {{--<div class="card">--}}
            {{--<div class="card-header with-border">--}}
                {{--<h3 class="card-title">Associated Servers</h3>--}}
            {{--</div>--}}
        ...
        <div class="card card-danger">
            ...
            <div class="card-footer">
                <form action="{{ route('admin.users.view', $user->id) }}" method="POST">
                    {!! csrf_field() !!}
                    {!! method_field('DELETE') !!}
                    <input id="delete" type="submit" class="btn btn-md btn-danger pull-right" {{ $user->servers->count() < 1 ?: 'disabled' }} value="Delete User" />
                </form>
            </div>
        </div>
    </div>
