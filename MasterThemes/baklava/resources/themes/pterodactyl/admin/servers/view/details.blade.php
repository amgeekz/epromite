...
<div class="row">
    <div class="col-md-12 mb-2">
        ...
        @if($server->installed === 1)
            <a class="btn btn-md btn-info" href="{{ route('admin.servers.view.details', $server->id) }}">Details</a>
        ...
        <div class="card card-primary">
            ...
            <form action="{{ route('admin.servers.view.details', $server->id) }}" method="POST">
                ...
                <div class="card-footer">
                    {!! csrf_field() !!}
                    {!! method_field('PATCH') !!}
                    <input type="submit" class="btn btn-md btn-primary" value="Update Details" />
                </div>
            </form>
        </div>
    </div>
