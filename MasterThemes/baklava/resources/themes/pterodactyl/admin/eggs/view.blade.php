...
<div class="row">
    <div class="col-md-12 mb-2">
        <a class="btn btn-md btn-info" href="{{ route('admin.nests.egg.view', $egg->id) }}">Configuration</a>
        <a class="btn btn-md btn-primary" href="{{ route('admin.nests.egg.variables', $egg->id) }}">Variables</a>
            ...
            <div class="card card-danger">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            {!! csrf_field() !!}
                            <button type="submit" name="_method" value="PUT" class="btn btn-md btn-danger pull-right">Update Egg</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-footer">
                    ...
                    <a href="{{ route('admin.nests.egg.export', ['option' => $egg->id]) }}" class="btn btn-md btn-info pull-right" style="margin-right:10px;">Export</a>
                    <button id="deleteButton" type="submit" name="_method" value="DELETE" class="btn btn-danger btn-md muted muted-hover">
