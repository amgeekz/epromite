        ...
        <div class="modal-content">
            <form action="{{ route('admin.packs.new') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    {!! csrf_field() !!}
                    <button type="submit" name="action" value="from_template" class="btn btn-primary btn-md">Install</button>
                    <button type="button" class="btn btn-secondary btn-md pull-left" data-dismiss="modal">Cancel</button>
                </div>
            </form>
        </div>
    </div>
